...
public enum OSCAContactError: Swift.Error, CustomStringConvertible {
...
}// end public enum OSCAContactError

extension OSCAContactError: Equatable{
  public static func == (lhs: OSCAContactError, rhs: OSCAContactError) -> Bool {
    switch (lhs, rhs) {
...
}// end extension public enum OSCAContactError
